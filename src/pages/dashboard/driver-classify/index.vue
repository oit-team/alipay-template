...
const { data, execute, isLoading } = useAxios('/vehicle/reportForm/getDriverClassificationReport', {}, { immediate: false })
const selectVal = ref()
watch(data, () => {
...
<template>
  <ElScrollbar v-loading="isLoading" class="text-center">
