...
const extraMap = [
  { prop: 't3DriverId', label: 'T3司机id' },
  { prop: 'city', label: '城市' },
  { prop: 't3DriverTypeVal', label: '司机类型' },
  { prop: 'driverFleet', label: '所属车队' },
  { prop: 'bindingTime', label: '绑车时间' },
  { prop: 'operator', label: '所属运营商' },
  { prop: 'entryTime', label: '入职日期' },
  { prop: 'resignationTime', label: '离职日期' },
  { prop: 't3DriverStatusVal', label: '司机状态' },
  { prop: 'idCardStatus', label: '身份证状态' },
  { prop: 'driversLicenseStatus', label: '驾驶证状态' },
  { prop: 'onlineRideHailingStatus', label: '司机网约车证' },
